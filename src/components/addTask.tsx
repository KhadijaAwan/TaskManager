    ...
    return (
        <>
            <form onSubmit={(e) => postData(e)} className={`${flexCenter} mb-3`}>
                <input className={`${inputStyle} focus:outline-gray-500`} value={task.detail} placeholder='Add your new todo' onChange={(e) =>
                    setTask((prevState) => ({
                        ...prevState,
                        detail: e.target.value,
                    }))
                } />
                <button type="submit" className={`${buttonStyle} bg-purple-700 hover:bg-purple-800 font-bold px-2 mr-1`}>
